...
//源码阅读顺序object->Array->Collection->Function->Utility
...
(function() {
  ...
  //将this的值给root，在客户端为window，服务端为exports
    var root = this;

  // Save the previous value of the `_` variable.
    // 将原来全局环境变量中的变量赋值给previousUnderscore
  ...
  // are declared here.
    //es5原生方法，如果浏览器支持，则underscore会优先使用
  var
  ...
  var _ = function(obj) {
    ...
    //如果不是 _ 函数的实例，则调用new运算符，返回实例化对象
